...
<Alert type="info" style="soft" direction="horizontal" icon="lucide:info" title="Note">
  {' '}
  This is written for my future references and learning purposes only. It’s best that you follow
  the 
  <a href="https://wiki.archlinux.org/title/Installation_guide" class="font-bold" target="_blank">
    official Arch Linux Wiki
  </a>
   to install Arch on your machine. I won’t take any responsibilities if you follow and messes up in
  the process.{' '}
</Alert>
