...
<Alert type="info" style="soft" direction="horizontal" icon="lucide:info" title="Lưu ý">
  {' '}
  Bài viết này chỉ để mình tham khảo lại trong tương lai và phục vụ cho mục đích tìm hiểu. Tốt nhất
  bạn nên làm theo hướng dẫn trong 
  <a href="https://wiki.archlinux.org/title/Installation_guide" class="font-bold" target="_blank">
    Wiki của Arch Linux
  </a>
   để cài Arch. Mình không chịu trách nhiệm nếu bạn làm theo và gặp lỗi trong quá trình thực
  hiện.{' '}
</Alert>
